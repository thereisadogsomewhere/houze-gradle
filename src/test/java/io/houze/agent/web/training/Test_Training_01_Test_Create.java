...
public class Test_Training_01_Test_Create extends AbstractTest {
    ...
    public void TC_01_Blank_Data(Method method) {
        ...
        ExtentTestManager.getTest().log(LogStatus.INFO, "Training - Step 03: Click to Close form button");
    ...
    public void TC_03_Valid_Data_Without_Project(Method method) {
        ...
        verifyEquals(trainingPage.getDynamicTextFirstRowTrainingList(TrainingData.List.COLUMN_NAME,
